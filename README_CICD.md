...
后端backend-services是java 17、spring boot 2.7.17、Maven的构建的3个微服务（api-gateway:8080, user-service:8081, qa-service:8082）。后端使用nacos来注册发现微服务，其IP和端口是54.219.180.170:8848
